...
const SERVICE_CALLBACK = Symbol('serviceCallback')
...
class Application extends Koa {
  constructor(options={}) {
    ...
    this.services = extend({}, services, this.pluginLoader.services, this.walk('app/service', this[SERVICE_CALLBACK]))
